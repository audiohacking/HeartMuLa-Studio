...
# HuggingFace model IDs — use 20260123 releases (recommended by HeartMuLa)
HF_HEARTCODEC_REPO = "HeartMuLa/HeartCodec-oss-20260123"  # Recommended: HeartCodec-oss-20260123
